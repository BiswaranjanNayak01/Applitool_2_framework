...
public class EyesBatchManager {
    private static final Logger log = LoggerFactory.getLogger(EyesBatchManager.class);
    ...
    private static RectangleSize viewportSize = new RectangleSize(1200, 600);
...
//            config.addBrowser(1200, 600, BrowserType.CHROME, baselineEnvName); // This is the "desktop-browser" baseline
...
//            config.addBrowser(1024, 768, BrowserType.IE_11, baselineEnvName);
            ...
            config.addBrowser(1200, 600, BrowserType.CHROME); // This is the "desktop-browser" baseline
